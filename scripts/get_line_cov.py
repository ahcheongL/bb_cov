...
def main(argv):
    if len(argv) < 2:
        ...
        print(
            "  [out.txt]: (Optional) Output file name to save line coverage info. If not provided, prints to stdout."
        )
        return 1
